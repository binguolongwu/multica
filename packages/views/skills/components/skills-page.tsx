...
const GRID_COLS =
  ...
  "@2xl:grid-cols-[0.75rem_1rem_2fr_5fr_var(--lgc-usedby)_var(--lgc-source)_var(--lgc-creator)_var(--lgc-skilltype)_var(--lgc-updated)_var(--lgc-created)_1.75rem_0.75rem]";
