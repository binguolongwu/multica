    ...
    <div className="flex flex-1 min-h-0 flex-col">
      ...
      <div className="flex flex-1 min-h-0 flex-col overflow-y-auto md:flex-row md:overflow-hidden">
        ...
        <aside className="flex max-h-44 w-full shrink-0 flex-col border-b md:max-h-none md:w-56 md:border-b-0 md:border-r">
          ...
          {selectedPath !== SKILL_MD && canEdit && !skill.is_builtin && (
              ...
              <div className="flex gap-2">
                ...
                <dd className="min-w-0 flex-1">
                  <span className={`rounded-md px-1.5 py-0.5 text-[10px] font-medium ${
                    skill.is_builtin ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" :
                    skill.skill_type === 'platform' ? "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400" :
                    "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"
                  }`}>
                    {skill.is_builtin ? "builtin" : skill.skill_type}
                  </span>
                </dd>
              </div>
              <div className="flex gap-2">
