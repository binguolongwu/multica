...
// HACK: TestShouldEnqueueOnComment_PrivateAgentGate removed — the
// shouldEnqueueAssigneeFallback method it tests does not exist in this fork.
// The helper functions privateAgentTestFixture and newRequestAs defined above
// are still used by other test files.
