...
SELECT al.agent_id, l.id, l.workspace_id, l.name, l.color, l.created_at, l.updated_at, l.resource_type, l.description
FROM issue_label l
JOIN agent_to_label al ON al.label_id = l.id
...
SELECT sl.skill_id, l.id, l.workspace_id, l.name, l.color, l.created_at, l.updated_at, l.resource_type, l.description
FROM issue_label l
JOIN skill_to_label sl ON sl.label_id = l.id
WHERE sl.skill_id = ANY($1::uuid[])
  AND l.workspace_id = $2::uuid
